...
#
# Script generated by Vivado on Thu Mar 26 13:24:17 GMT 2026
...
compile()
{
  ...
  xmvhdl -work floating_point_v7_0_21 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/floating_point_v7_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_dsp48_mult_v3_0_7 -V93 $xmvhdl_opts \
  ...
  xmvhdl -work div_gen_v5_1_20 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.divider xil_defaultlib.glbl
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alex/HDL_PROJECTS/MOV_AVER/MOV_AVER_PR/MOV_AVER_PR.cache/compile_simlib/xcelium"
  fi
