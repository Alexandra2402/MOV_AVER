...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_fifo xil_defaultlib.input_fifo xil_defaultlib.glbl -log elaborate.log
}
