...
#
# Script generated by Vivado on Mon Mar 30 09:47:20 +0300 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mov_aver_tb.sh
...
#
# Usage        : mov_aver_tb.sh
#                mov_aver_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mov_aver_tb.sh [-reset_run]
#                mov_aver_tb.sh [-reset_log]
#                mov_aver_tb.sh [-help]
#
...
#                script (type 'mov_aver_tb.sh -help' for more information).
#
...
# script info
echo -e "mov_aver_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mov_aver_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Viv24.2_library_Questa"
  fi
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mov_aver_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mov_aver_tb.sh [-help]\n\
Usage: mov_aver_tb.sh [-step]\n\
Usage: mov_aver_tb.sh [-lib_map_path]\n\
Usage: mov_aver_tb.sh [-reset_run]\n\
Usage: mov_aver_tb.sh [-reset_log]\n\
Usage: mov_aver_tb.sh [-keep_index]\n\
Usage: mov_aver_tb.sh [-noclean_files]\n\n\
