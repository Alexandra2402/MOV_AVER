...
#
# Script generated by Vivado on Sun Mar 29 11:03:58 +0300 2026
...
#
# Usage        : input_fifo.sh
#                input_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_fifo.sh [-reset_run]
#                input_fifo.sh [-reset_log]
#                input_fifo.sh [-help]
#
...
export RDI_DATADIR="C:/Xilinx24.2/Vivado/2024.2/data"
...
# script info
echo -e "input_fifo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_fifo xil_defaultlib.input_fifo xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx24.2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb input_fifo.wdb xsim.dir libdpi.so)
...
Usage: input_fifo.sh [-step]\n\
Usage: input_fifo.sh [-lib_map_path]\n\
Usage: input_fifo.sh [-reset_run]\n\
Usage: input_fifo.sh [-reset_log]\n\
Usage: input_fifo.sh [-keep_index]\n\
