...
#
# Script generated by Vivado on Thu Mar 26 08:55:20 GMT 2026
...
#                script (type 'input_fifo.sh -help' for more information).
#
...
# script info
echo -e "input_fifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.input_fifo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.input_fifo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log input_fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
